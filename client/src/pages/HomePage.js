        ...
        {user ? (
          ...
          <header className="main-header">
            <div className="main-header-left-side">
              <h1 className="display-1">IraqiExpert</h1>
              <img src={iraq_map} alt="map of Iraq" />
            </div>
            <div className="main-header-info">
              <p>
                اهلا وسهلا بك في موقع عراق اكسبرت. حيث تستطيع ان تتواصل مع ناس من
                مختلف المهن. وان تنسق معهم على مشاريع شخصية ام مشاريع تفيد
                المجتمع.
              </p>
              <p>
                Hello and Welcome to IraqiExpert. Where you can network with others
